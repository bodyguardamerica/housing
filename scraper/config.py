...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            scrape_interval_seconds=int(os.environ.get("SCRAPE_INTERVAL_SECONDS", "25")),  # 25s — slightly faster than genconhotels.com's proven 30s default; the fresh-session-per-scrape pattern keeps Passkey happy.
            default_check_in=os.environ.get("DEFAULT_CHECK_IN", "2026-07-29"),
            default_check_out=os.environ.get("DEFAULT_CHECK_OUT", "2026-08-02"),
